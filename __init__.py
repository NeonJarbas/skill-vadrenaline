...
class VAdrenalineSkill(OVOSCommonPlaybackSkill):
    ...
    def _sync_db(self):
        url = "https://www.youtube.com/c/ViewsterTVMovies"
    ...
    def search_db(self, phrase, media_type):
        ...
        if self.voc_match(phrase, "vadrenaline"):
            yield self.get_playlist(base_score)
        if media_type == MediaType.MOVIE:
            # only search db if user explicitly requested adrenaline
